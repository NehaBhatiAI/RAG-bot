...
if "groq_api_key" not in st.session_state:
    # First try from .env, fallback to empty
...
def setup_rag_chain():
    if not st.session_state.groq_api_key:
        return None, "Please enter your Groq API key in the sidebar or .env file."
...
with st.sidebar:
    ...
    # API Key input
    groq_api_key_input = st.text_input("Groq API Key", type="password", value=st.session_state.groq_api_key)
